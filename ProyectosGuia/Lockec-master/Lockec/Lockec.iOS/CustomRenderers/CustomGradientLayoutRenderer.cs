using CoreAnimation;
using CoreGraphics;
using Lockec.Controllers.Gradient;
using Lockec.iOS.CustomRenderers;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(GradientLayout), typeof(CustomGradientLayoutRenderer))]
namespace Lockec.iOS.CustomRenderers
{
    class CustomGradientLayoutRenderer : VisualElementRenderer<StackLayout>
    {
